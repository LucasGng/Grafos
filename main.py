...
grafo.add_edge("B","F",1)
grafo.add_edge("B","E",1)
grafo.add_edge("B","C",1)
grafo.add_edge("C","D",1)
grafo.add_edge("D","C",1)
grafo.add_edge("D","H",1)
grafo.add_edge("G","H",1)
grafo.add_edge("F","G",1)
grafo.add_edge("G","F",1)
grafo.add_edge("E","F",1)
grafo.add_edge("E","A",1)
